...
| 节点  | 地址         | 端口  | 密码             | 加密方式        |
|-------|--------------|-------|------------------|-----------------|
| ipv6 节点  | 2a14:7584:d0a1::a| 12345| dongtaiwang.com  | aes-256-gcm     |


**SS链接**

```bash
ss://YWVzLTI1Ni1nY206ZG9uZ3RhaXdhbmcuY29t@[2a14:7584:d0a1::a]:12345#SS%E8%8A%82%E7%82%B9-ipv6
```
