...
**更新时间：** 北京时间2026年6月24日14点00分更新节点3
...
| 节点参数               | 参数值                              |
|--------------------|-----------------------------------|
| Address（地址）    | clash-ip1.934618.xyz|
| Port（端口）       | 18271|
| Password（密码）     | github.com/Alvin9999-newpac/fanqiang |
| TLS（传输层安全）   | tls                           |
| SNI (serverName)   |  clash-ip1.934618.xyz       |
| Alpn | h3                            |
...
```bash
hysteria2://github.com%2FAlvin9999-newpac%2Ffanqiang@clash-ip1.934618.xyz:18271?sni=clash-ip1.934618.xyz&insecure=0#hysteria2-ipv4
```
