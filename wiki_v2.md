...
**更新时间：** 北京时间2026年4月28日23点30分更新节点3
...
| 节点参数               | 参数值                              |
|--------------------|-----------------------------------|
| Address（地址）    | 2a14:7584:d117::14|
| Port（端口）       | 27802|
| UUID（用户ID）     | b9887ee9-606b-4665-a4ea-7443ca049a68 |
| alterid（额外ID）     | 0                 |
| security（加密方式）| auto                           |
| network（传输协议） | ws                               |
...
```bash
vmess:
```
...
```bash
hysteria2://github.com%2FAlvin9999-newpac%2Ffanqiang@83.243.86.103:12855?sni=www.microsoft.com&insecure=1#hysteria2-warp
```
