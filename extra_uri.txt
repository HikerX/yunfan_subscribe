...
**更新时间：** 北京时间2026年4月22日17点30分更新节点3
...
| [https://s3.dualstack.us-east-1.amazonaws.com/zhifan/v2ray.html](https://s3.dualstack.us-east-1.amazonaws.com/zhifan/v2ray.html)         | Free Air镜像，建议保存|    
...
| 节点参数               | 参数值                              |
|--------------------|-----------------------------------|
| Address（地址）    | 2a14:7584:d118::a|
| Port（端口）       | 10736|
| UUID（用户ID）     | 2b8e0bfe-0fb2-475b-91db-824b2f4e9a1b |
| alterid（额外ID）     | 0                 |
| security（加密方式）| auto                           |
| network（传输协议） | ws                               |
...
```bash
vmess:
```
...
```bash
hysteria2://github.com%2FAlvin9999-newpac%2Ffanqiang@83.243.86.103:38563?sni=www.microsoft.com&insecure=1#hysteria2-warp
```
